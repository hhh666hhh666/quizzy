...
目前 `package.json` 里**没有这两个 script**，CI 对前端的门禁只有类型检查与构建。这是登记过的取舍，不是遗漏——见 [../README.md](../README.md) 的「已知取舍」。
...
盲区只做描述，**不在文档里开待办清单**——要转化为行动，去 [../TODO/](../TODO/) 新建一条（命名规则见 [../TODO/README.md](../TODO/README.md)）。
